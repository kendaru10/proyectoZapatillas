                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            lista.Add(new Producto()
                            {
                                ...
                                oCategoria = new Categoria() { IdCategoria = Convert.ToInt32(dr["IdProducto"]), Descripcion = dr["DesCategoria"].ToString() },
        ...
        public bool Editar(Producto obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    cmd.Parameters.Add("Mensaje", SqlDbType.VarChar, 500).Direction = ParameterDirection.Output;  // Agrega este parámetro de salida
                    cmd.CommandType = CommandType.StoredProcedure;
